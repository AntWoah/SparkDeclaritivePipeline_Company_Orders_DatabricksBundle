# SDP_CompanyOrders_Bundle

The 'SDP_CompanyOrders_Bundle' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/SDP_CompanyOrders_Bundle/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] SDP_CompanyOrders_Bundle_etl` to your workspace.
